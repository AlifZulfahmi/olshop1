                ...
                <div class="px-4 md:px-5">
                    ...
                    <div id="myTabContent">
                        <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="Category" role="tabpanel" aria-labelledby="Category-tab">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input id="category-{{ $category->id }}" name="category[]" type="checkbox" value="{{ $category->id }}" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
                                    <label for="category-{{ $category->id }}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $category->name }} ({{ $category->products->count() }})</label>
                                </div>
                            </div>
                            @endforeach
                        </div>
