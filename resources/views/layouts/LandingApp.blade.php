...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('assets/landing/img/fav.png') }}" />
    <!-- Author Meta -->
  ...
  ============================================= -->
    ...
    <style>
        .single-product img {
            width: 100%;
            /* Menyesuaikan lebar gambar dengan kontainer */
            height: 200px;
            /* Menentukan tinggi gambar, bisa diubah sesuai kebutuhan */
            object-fit: cover;
            /* Menjaga rasio gambar dan meng-crop jika diperlukan */
            border-radius: 8px;
            /* Menambahkan sudut membulat jika diperlukan */
        }
    </style>
    ...
    <link rel="stylesheet" href="{{ asset('assets/landing/css/nouislider.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/landing/css/ion.rangeSlider.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/landing/css/ion.rangeSlider.skinFlat.css') }}" />
...
<body>
    ...
    <script src="{{ asset('assets/landing/js/nouislider.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/landing/js/gmaps.min.js') }}"></script>
